...
public class MuestraSubscriptor : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        subscriptor.EnCasoDeEspacioPresionado += MensajeEscuchadoPorElSubscriptor; //Subscribirse
    }
    ...
    private void MensajeEscuchadoPorElSubscriptor(object sender, EventArgs e)
    {
        ...
        subscriptor.EnCasoDeEspacioPresionado -= MensajeEscuchadoPorElSubscriptor; //Desubscribirse
    }
}
